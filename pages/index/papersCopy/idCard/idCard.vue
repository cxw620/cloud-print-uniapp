...
export default {
	...
	methods: {
		...
		btnorder() {
			...
			ctx.drawImage(this.identityFront.imgUrl, 176, 150, 243, 153);
			ctx.drawImage(this.identityContrary.imgUrl, 176, 450, 243, 153);
			ctx.setFontSize(15);
			ctx.fillStyle = 'rgba(255,255,255,0.5)';
			// ctx.fillStyle = '#000';
			ctx.fillText(watermarkVal, 210, 170);
			ctx.fillText(watermarkVal, 210, 470);
			ctx.draw();
			setTimeout(() => {
